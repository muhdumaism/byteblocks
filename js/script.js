...
const config = {
    serverInfo: {
        ...
        serverName: "ASTERICK MC", /*Server name*/
        serverIp: "mc.asterick.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1121330598179516436" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    adminTeamPage: {
        leaders: [
            {
                inGameName: "Byte",
                rank: "Founder",
                skinUrlOrPathToFile: "byte.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "ZXF1",
                rank: "Owner",
                skinUrlOrPathToFile: "zxf1.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Zaidara",
        ...
        developers: [
            ...
            },
            {
                inGameName: "ASIN444",
                rank: "ADMIN",
                skinUrlOrPathToFile: "asin444.png",
                rankColor: ""
            },
            {
                inGameName: "andi undo?",
                rank: "Webmaster",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
